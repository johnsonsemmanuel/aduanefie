...
export const orders: Order[] = [
  { id: 'o1', orderNumber: 'ORD-2026-001', commodity: { id: 'cm1', name: 'NPK Fertilizer' }, quantity: 2000, unit: 'bags', total: 600000, status: 'in_transit', paymentStatus: 'completed', supplier: { id: 's1', name: 'Dar Agro Inputs' }, buyer: { id: 'b1', name: 'Midwest Farmers Coop' }, createdAt: '2026-05-28', updatedAt: '2026-06-05', deliveryDate: '2026-07-05', tracking: ['Dispatched from Dar', 'Arrived at Mwanza Hub', 'In transit to buyer'], items: [{ id: 'oi1', commodity: 'NPK 15:15:15', quantity: 2000, unit: 'bags', price: 300, total: 600000 }] },
  { id: 'o2', orderNumber: 'ORD-2026-002', commodity: { id: 'cm2', name: 'Premium Cocoa Beans' }, quantity: 25, unit: 'tonne', total: 72500, status: 'processing', paymentStatus: 'partial', supplier: { id: 's2', name: 'Ghana Cocoa Board Coop' }, buyer: { id: 'b2', name: 'European Chocolate Co' }, createdAt: '2026-06-01', updatedAt: '2026-06-04', deliveryDate: '2026-07-15', tracking: ['Order confirmed', 'Quality inspection pending'], items: [{ id: 'oi2', commodity: 'Premium Cocoa Beans', quantity: 25, unit: 'tonne', price: 2900, total: 72500 }] },
  { id: 'o3', orderNumber: 'ORD-2026-003', commodity: { id: 'cm3', name: 'Cassava' }, quantity: 80, unit: 'tonne', total: 37600, status: 'delivered', paymentStatus: 'completed', supplier: { id: 's3', name: 'West African Produce Co' }, buyer: { id: 'b3', name: 'Lagos Food Processors' }, createdAt: '2026-05-20', updatedAt: '2026-06-02', deliveryDate: '2026-06-01', tracking: ['Order placed', 'Harvested', 'In transit', 'Delivered'], items: [{ id: 'oi3', commodity: 'Fresh Cassava', quantity: 80, unit: 'tonne', price: 470, total: 37600 }] },
  { id: 'o4', orderNumber: 'ORD-2026-004', commodity: { id: 'cm4', name: 'Soya Beans' }, quantity: 150, unit: 'tonne', total: 78000, status: 'pending', paymentStatus: 'pending', supplier: { id: 's4', name: 'East Africa Grains Ltd' }, buyer: { id: 'b4', name: 'Livestock Feed Corp' }, createdAt: '2026-06-05', updatedAt: '2026-06-05', deliveryDate: '2026-07-01', tracking: ['Awaiting confirmation'], items: [{ id: 'oi4', commodity: 'Soya Beans', quantity: 150, unit: 'tonne', price: 520, total: 78000 }] },
]
