  ...
  return (
    <PageShell
      tabs={[
        ...
        { id: 'demand', icon: Users, label: 'Demand' },
    ...
    >
      <div className="space-y-4 min-w-0">
              ...
              <GlassCard padding="none">
                <GlassCardHeader className="px-4 pt-4">
                  <div className="flex items-center gap-2">
                    <GlassCardTitle>{selectedCommodity.name}</GlassCardTitle>
              ...
              <GlassCard padding="none">
                ...
                <div className="px-4 pb-4 space-y-1">
                  {commodityDetails.slice(0, 6).map((c) => (
                    <div
                      key={c.id}
                      className="flex items-center justify-between py-1.5 px-2 rounded-md hover:bg-surface-hover transition-colors cursor-pointer"
                      onClick={() => setSelectedCommodity(c)}
                    >
        ...
        {activeTab === 'prices' && (
          <GlassCard>
            <GlassCardHeader>
              <GlassCardTitle>Price Analysis</GlassCardTitle>
            </GlassCardHeader>
        ...
        {activeTab === 'weather' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <GlassCard>
              <GlassCardHeader>
                <GlassCardTitle>Weather Impact Summary</GlassCardTitle>
              </GlassCardHeader>
        ...
        {activeTab === 'demand' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <GlassCard>
              <GlassCardHeader>
                <GlassCardTitle>Supply-Demand Overview</GlassCardTitle>
              </GlassCardHeader>
              <div className="space-y-3">
                {demandData.map((d) => (
